...
All emails are `@demo.local`. This overlaps with `scripts/seed.py`
...
|---|---|---|
| admin1@demo.local | `00000000-0000-0000-0000-000000000601` | Ritu Agarwal |
| admin2@demo.local | `00000000-0000-0000-0000-000000000602` | Manoj Krishnan |

## Staff

| Email | Fixed user id | Name |
|---|---|---|
| staff1@demo.local | `00000000-0000-0000-0000-000000000603` | Neha Kulkarni |
| staff2@demo.local | `00000000-0000-0000-0000-000000000604` | Suresh Pillai |

## Doctors

| Email | Fixed user id | Name | Specialty | Clinic |
|---|---|---|---|---|
| doctor1@demo.local | `...000401` | Dr. Ananya Rao | General medicine | Yamuna Nagar PHC (Delhi) |
| doctor2@demo.local | `...000402` | Dr. Vikram Shah | Cardiology | Shivaji Nagar CHC (Maharashtra) |
| doctor3@demo.local | `...000403` | Dr. Meera Iyer | Paediatrics | Jayanagar Clinic (Karnataka) |
| doctor4@demo.local | `...000404` | Dr. Rohan Kapoor | Dermatology | Yamuna Nagar PHC (Delhi) |
| doctor5@demo.local | `...000405` | Dr. Priya Nair | Orthopaedics | Shivaji Nagar CHC (Maharashtra) |
| doctor6@demo.local | `...000406` | Dr. Arjun Malhotra | Neurology | Jayanagar Clinic (Karnataka) |
...
12 patients, `patient1@demo.local` .. `patient12@demo.local`, fixed user ids
